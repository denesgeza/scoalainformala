...
# ': ' inseamna ca nu exista date pentru anul respectiv
#
# 1) se cere realizarea unei functii get_year_data() care sa contina 2 param:
# Setul de date si anul pentru care se doreste preluarea datelor
...
# 2) se cere realizarea unei functii get_country_data(dataset, "Romania"), care sa contina 2 param.datasetul si tara
#     pentru care se doreste primirea datelor.
# ex: get_country_data(dataset, "Romania")
# returneaza {'Romania': [('2019', 84), ('2018', 86), ..., ('2011', 72)]}
# 3) de asemenea, se cere realizarea unei functii
# perform_average(country_data['Romania']) care sa returneze media per tara,
# ex perform_average(country_data['Romania']) returneaza 79.4 structura datelor trebuie sa pentru o preluare rapida:
# {
#     'Romania': [
#         {
#             'year': '2019',
...
#
# ]}
# Utilizand setul de date de mai sus:
# 1. Salvati datele in CSV
